...
namespace Models
{
    public class Contact
    {
        ...
        [Required(ErrorMessageResourceName = "SubjectRequired", ErrorMessageResourceType = typeof(Resources.Contact.ContactAjax))]
        [StringLength(200, MinimumLength = 2, ErrorMessageResourceName = "SubjectMax", ErrorMessageResourceType = typeof(Resources.Contact.ContactAjax))]
